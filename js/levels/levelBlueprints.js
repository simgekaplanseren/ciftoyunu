...
export function buildMagusaLayout() {
  ...
  return b
    .ground(0, 300)
    .plat(80, 28, 72).heart(105, 28)
    .groundEnemy(200, { type: 'jumper', patrolMin: 140, patrolMax: 380, speed: 26, jumpInterval: 2.0 })
    .gap(380)
    .ground(436, 280)
    .plat(480, 32, 80)
    .groundEnemy(520, { type: 'charger', patrolMin: 440, patrolMax: 680, speed: 30, chargeSpeed: 120 })
    .heart(560, 32)
    .gap(716)
    .ground(772, 300)
    .movingPlat(820, 0, 60, 40, 0.38)
    .groundEnemy(880, { type: 'jumper', patrolMin: 780, patrolMax: 1020, speed: 28 })
    .plat(940, 36, 72).heart(965, 36)
    .gap(1072)
    .ground(1128, 320)
    .groundEnemy(1180, { type: 'charger', patrolMin: 1140, patrolMax: 1380, speed: 32, chargeSpeed: 135 })
    .plat(1240, 30, 80)
    .flyOver(1260, 30, { type: 'bat', patrolMin: 1130, patrolMax: 1400, speed: 34, flyAmplitude: 10 })
    .gap(1452)
    .ground(1508, 340)
    .groundEnemy(1560, { type: 'jumper', patrolMin: 1520, patrolMax: 1760, speed: 30 })
    .heart(1660, 0)
    .finish()
    .build();
}
...
export function buildGoztepeLayout() {
  ...
  return b
    .ground(0, 280)
    .plat(60, 22, 64)
    .plat(160, 38, 64).heart(180, 38)
    .plat(260, 52, 64)
    .groundEnemy(300, { type: 'jumper', patrolMin: 260, patrolMax: 480, speed: 26 })
    .gap(480)
    .ground(536, 300)
    .plat(580, 24, 72)
    .plat(680, 40, 72)
    .plat(780, 52, 72).heart(800, 52)
    .groundEnemy(820, { type: 'bat', patrolMin: 540, patrolMax: 900, speed: 34, flying: true, flyAmplitude: 18 })
    .gap(900)
    .ground(956, 320)
    .groundEnemy(1000, { type: 'charger', patrolMin: 960, patrolMax: 1200, speed: 30, chargeSpeed: 125 })
    .movingPlat(1060, 0, 68, 36, 0.4)
    .plat(1140, 28, 80).heart(1165, 28)
    .gap(1300)
    .ground(1356, 340)
    .plat(1400, 22, 64)
    .plat(1500, 38, 64)
    .plat(1600, 52, 64)
    .groundEnemy(1640, { type: 'jumper', patrolMin: 1360, patrolMax: 1680, speed: 28 })
    .flyOver(1560, 52, { type: 'bat', patrolMin: 1400, patrolMax: 1680, speed: 36, flyAmplitude: 12 })
    .heart(1720, 0)
    .finish()
    .build();
}
...
export function buildSirinceLayout() {
  ...
  return b
    .ground(0, 300)
    .plat(60, 24, 64)
    .plat(160, 40, 64).heart(180, 40)
    .plat(260, 52, 64)
    .groundEnemy(320, { type: 'jumper', patrolMin: 280, patrolMax: 500, speed: 28 })
    .gap(500)
    .ground(556, 320)
    .flyOver(580, 0, { type: 'ghost', patrolMin: 540, patrolMax: 780, speed: 26, flyAmplitude: 16 })
    .groundEnemy(640, { type: 'turtle', patrolMin: 560, patrolMax: 820, speed: 20 })
    .plat(700, 26, 80).heart(725, 26)
    .gap(876)
    .ground(932, 340)
    .movingPlat(980, 0, 64, 38, 0.36)
    .plat(1060, 28, 80)
    .groundEnemy(1100, { type: 'jumper', patrolMin: 940, patrolMax: 1200, speed: 30 })
    .gap(1240)
    .ground(1296, 360)
    .plat(1340, 22, 64)
    .plat(1440, 38, 64)
    .plat(1540, 52, 64).heart(1560, 52)
    .groundEnemy(1600, { type: 'turtle', patrolMin: 1300, patrolMax: 1640, speed: 22 })
    .flyOver(1500, 52, { type: 'ghost', patrolMin: 1340, patrolMax: 1640, speed: 28, flyAmplitude: 12 })
    .heart(1720, 0)
    .finish()
    .build();
}
