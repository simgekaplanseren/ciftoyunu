...
export function buildKusadasiLayout() {
  ...
  return b
    ...
    .heart(540, 0)
    .gap(56, 'water').gapMovingPlat(12, 32, 52, 0.38)
    .nextGround(360)
    ...
    .secretKey('k6', 1120, 0)
    .heart(1160, 0)
    .gap(56, 'water').gapMovingPlat(14, 30, 54, 0.36)
    .nextGround(360)
...
export function buildSirinceLayout() {
  ...
  return b
    ...
    .gap().gapMovingPlat(12, 28, 50, 0.34, 'sirince')
    .nextGround(360)
...
export function buildDogumGunuLayout() {
  ...
  return b
    .ground(0, 420)
    .heartHere(100)
    .groundEnemyHere(200, { type: 'crab', speed: 38 })
    .gap(56, 'water')
    .nextGround(360)
    .heartHere(80)
    .groundEnemyHere(200, { type: 'crab', speed: 40 })
    .gap(56, 'water').gapMovingPlat(12, 32, 52, 0.36, 'dogumgunu')
    .nextGround(380)
    .heartHere(100)
    .groundEnemyHere(240, { type: 'walker', speed: 22 })
    .jumpGap()
    .nextGround(360)
    .heartHere(80)
    .gap(56, 'water')
    .nextGround(400)
    .secretKeyHere('k7', 200)
    .heartHere(280)
    .groundEnemyHere(320, { type: 'crab', speed: 42 })
    .gap(56, 'water')
    .nextGround(380)
    .heartHere(120)
    .finish()
